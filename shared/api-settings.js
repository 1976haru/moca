...
var MOCA_APIS_V2 = {
  ...
  '음성 생성': [
    ...
    { id:'openai_tts', name:'OpenAI TTS',         keyName:'uc_openai_key',
      ...
      url:'https://platform.openai.com/api-keys',
      free:'1,000자당 약 ₩20' },
    { id:'daglo',     name:'Daglo STT (음성 인식)', keyName:'uc_daglo_key',
      desc:'한국어 음성 → 자막 자동 생성. 영상 리믹스 스튜디오의 STT 백엔드.',
      placeholder:'daglo API key',
      guide:'1. daglo.ai 접속\n2. 회원가입\n3. API Key 발급\n\n[저장 위치]\n키는 통합 store(voice.daglo) 와 legacy uc_daglo_key 양쪽에 저장. 실제 호출은 서버 환경변수 DAGLO_API_KEY 를 사용 — 프론트엔드에서는 호출 안 함.',
      url:'https://daglo.ai/',
      free:'유료 (요금제 별 다름)' },
    { id:'whisper_api',name:'OpenAI Whisper (STT)', keyName:'uc_openai_key',
      desc:'영상/오디오 → 자막 자동 생성 (OpenAI 키 공유). 영상 리믹스 스튜디오의 STT 백엔드 fallback.',
      placeholder:'sk-proj-... (OpenAI 키와 동일)',
      guide:'OpenAI API 키와 동일하게 사용됩니다. 서버 환경변수 OPENAI_API_KEY 가 설정되면 STT 호출 가능.',
      url:'https://platform.openai.com/api-keys',
      free:'분당 약 ₩8 (whisper-1)' },
