...
(function(){
  ...
  var COPY_NOTICE = [
    '유튜브 원본 영상 파일을 다운로드하거나 재사용하지 않습니다. 영상은 iframe 으로 미리보기만 하며, ' +
      '자막/대본은 사용자가 직접 붙여넣은 내용 또는 공개 자막 텍스트만 가져옵니다.',
    '본인 영상 또는 사용 허가를 받은 영상만 음성 교체·자막 교체 결과물로 사용하세요.',
    '공개 영상은 구조 분석과 참고용으로만 사용하고, 원본 화면·로고·캐릭터·문장을 그대로 복제하지 마세요.',
    '공개 자막 가져오기는 학습·분석·리믹스 준비를 돕기 위한 보조(실험) 기능입니다. 결과물을 제작·배포할 때는 ' +
      '본인 영상 또는 사용 허가를 받은 영상만 사용하세요.',
    '원본 영상·오디오 파일은 다운로드하지 않으며, 공개 자막 텍스트만 가져오기를 시도합니다.',
  ];
